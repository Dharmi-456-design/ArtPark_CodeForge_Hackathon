        ...
        >
          ...
          {roadmap.map((step) => {
            ...
            return (
              ...
              >
                {/* Step Number */}
                <div className="absolute left-0 w-12 h-12 bg-white dark:bg-slate-900 border-2 border-indigo-500 rounded-xl flex items-center justify-center shadow-sm">
                  <span className="text-lg font-bold text-indigo-600 dark:text-indigo-400">{step.step}</span>
                </div>

                {/* Content Card */}
                <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl border border-slate-100 dark:border-slate-800 p-5 hover:shadow-md hover:border-slate-200 dark:hover:border-slate-700 transition-all group">
