  ...
  return (
    <section className="py-32 relative text-center overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto px-6 relative z-10">
        <motion.h2 initial={{ opacity: 0, y: 30 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-4xl md:text-6xl font-black mb-6 text-slate-900 dark:text-white leading-tight" style={{ fontFamily: "'Syne', sans-serif" }}>
